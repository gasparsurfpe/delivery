object frmBairros: TfrmBairros
  ...
  object gbFiltro: TGroupBox
    ...
    object edtBusca: TEdit
      ...
      Height = 25
      TabOrder = 0
      TextHint = 'Digite o nome do bairro'
  ...
  object grdBairros: TDBGrid
    Left = 8
    Top = 126
    Width = 681
    Height = 227
    DataSource = Tabelas.DSmt_district
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Tahoma'
    ...
    TitleFont.Style = []
    OnDrawColumnCell = grdBairrosDrawColumnCell
    OnDblClick = grdBairrosDblClick
    Columns = <
      item
        Expanded = False
        FieldName = 'command'
